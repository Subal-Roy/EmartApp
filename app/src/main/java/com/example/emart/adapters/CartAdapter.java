...
import com.example.emart.activities.CartActivity;
import com.example.emart.databinding.ItemCartBinding;
import com.example.emart.databinding.QuantityDialogBinding;
                ...
                quantityDialogBinding.plusBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(quantity > product.getStock()){
                            Toast.makeText(context,"Max stack Available: "+product.getStock(),Toast.LENGTH_SHORT).show();
                            return;
                ...
                quantityDialogBinding.minusBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(quantity > 1){
                            ...
                            Toast.makeText(context,"Can't Select less than 1",Toast.LENGTH_SHORT).show();
                            return;
                        }
